...
assapp - oapp1 1,0 oapp2 1,1
app1right - app1 1,0 app2 0,1
comapp - app1 2,1 app2 2,1
memapp2 - omem1 1,1 omem2 1,1 omem3 0,2, oapp1 1,2 oapp2 0,2
memapp3 - omem1 1,2 omem2 1,1 omem3 0,2, oapp1 1,2 oapp2 0,2

assapp - app1 1,0 app2 1,2
       - same.
app1right - app1 1,0 app2 0,2
       - same.
comapp - app1 2,1 app2 2,1
       -same
memapp2 - 
         omem1 0,1 omem2 0,1 omem3 0,2 oapp1 0,2 oapp2 0,2
memapp3 - 
         omem1 0,2 omem2 0,1 omem3 0,2 oapp1 0,2 oapp2 0,2
...
% simple list theory
% 
top_goal_c pdd_nominate_tests pdd_assapp []
...
top_goal_c pdd_nominate_tests pdd_app1right []
...
top_goal_c pdd_nominate_tests pdd_cnc_app []
	(app and [(app forall  [(olist nat), (abs (v0\ 
...
top_goal_c pdd_nominate_tests pdd_comapp []
	(app and [(app forall  [(olist nat), (abs  (v0\ 
		(app forall  [(olist nat), (abs (v1\ 
...
top_goal_c pdd_nominate_tests pdd_memapp2 []
...
top_goal_c pdd_nominate_tests pdd_memapp3 []
	(app and [(app forall  [nat, (abs (v0\ 
		(app forall  [(olist nat), (abs (v1\ 
			(app forall  [(olist nat), (abs (v2\ 
...
top_goal_c pdd_nominate_tests pdd_memapp []
...
top_goal_c pdd_nominate_tests pdd_countsort []
	(app and [(app forall  [nat, (abs (a\
		(app forall  [(olist nat), (abs (l\
...
top_goal_c pdd_nominate_tests pdd_lensort []
...
top_goal_c pdd_nominate_tests pdd_memins []
...
top_goal_c pdd_nominate_tests pdd_meminsert1 []
	(app and [(app forall  [nat, (abs (a\
...
top_goal_c pdd_nominate_tests pdd_meminsert2 []
        (app and [(app forall  [nat, (abs (a\
                (app forall  [nat, (abs (b\
                        (app forall  [(olist nat), (abs (l\
        (app imp  [(app neq  [a, b]),
...
top_goal_c pdd_nominate_tests pdd_memsort1 []
	(app and [(app forall  [nat, (abs (x\
	(app forall  [(olist nat), (abs (l\
...
top_goal_c pdd_nominate_tests pdd_memsort2 []
	(app and [(app forall  [nat, (abs (x\
		(app forall  [(olist nat), (abs (l\
...
top_goal_c pdd_nominate_tests pdd_ordered_cons []
	(app and [(app forall  [nat, (abs (x\
		(app forall  [(olist nat), (abs (y\
	(app imp  [
