...
type abs (osyn -> osyn) -> osyn -> osyn.
type app osyn -> (list osyn)-> osyn.

type nha hyp_ann.
type hyp osyn -> hyp_ann -> osyn.
type witness_term hyp_ann.
...
type    arrow   (list osyn) -> osyn -> osyn.
...
type copy_term    (list osyn) -> (list osyn) -> o.
...
type env_otype_inst_types  osyn -> (list osyn) -> osyn -> o.
type constant osyn -> osyn -> o.
...
type contains_meta_var_term osyn -> o.
