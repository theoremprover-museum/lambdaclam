...
type ly_id string -> gs.    % universal identifier
type iconst int -> gs.
type sconst string -> gs.
%% type test int -> gs -> o.    JB: compatibility problems with test.mod!
type ntnum int -> o.
type first gs -> gs -> o.
